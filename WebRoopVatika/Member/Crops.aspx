<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Crops.aspx.cs" Inherits="Member_Crops" %>
     ...
     <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="RID" 
                    DataNavigateUrlFormatString="Order.aspx?rid={0}" HeaderText="Action" 
                    Text="Order " />
            </Columns>
